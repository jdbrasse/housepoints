...
def aggregate_weekly(df, week_label, target):
    ...
    # Merge with permanent staff list so everyone appears
...
def update_cumulative_tracker(staff_weekly_df, cumulative_path):
    ...
    # Ensure permanent staff are always shown
    permanent_df = pd.DataFrame(PERMANENT_STAFF)
...
if uploaded_file is not None:
    ...
    if st.button("Run analysis"):
        ...
        # Top Students (House chart with colours)
        ...
        if not student_df.empty:
            fig_students = px.bar(
                ...
                hover_data={"Pupil Name": True, "House Points This Week": True, "Year": True, "Form": True, "House": True},
